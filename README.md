...
### Features
- **Custom Formatting**: The class file enforces a consistent style for official documents.
- **Easy Reference Management**: The reference file simplifies citation and bibliography formatting.
- **Bilingual Support**: Documentation is provided in both English and Chinese.
...
### 联系方式
如有疑问或需要支持，请联系 [Frankie(Yeats)](https://xlog.frankie.science)
